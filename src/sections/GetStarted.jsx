...
import { beforeAfterVariants, imageFadeIn, imageVariants, itemVariants, textVariants } from '../variants';
       ...
       <section className="flex gap-[50px] justify-between items-start max-w-6xl mx-auto mt-36">
            <motion.div 
              ...
              className="flex w-[40%] flex-col items-start">
                ...
                <motion.p variants={itemVariants} className='mb-7 text-neutral-400 leading-7 tracking-wide text-start text-[16px] max-w-lg'>
