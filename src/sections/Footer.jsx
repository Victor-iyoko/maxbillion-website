        ...
        <div className="relative z-10 text-white rounded-3xl h-full border-2 border-[var(--secondary-color)] p-4 sm:p-6 md:p-10 pb-12">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-y-2 sm:gap-0 justify-between mt-2">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-neutral-300 font-semibold text-xs tracking-widest">08125013644</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-4 aspect-square text-gray-300" viewBox="0 0 16 16">
                      <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
                    </svg>
                     <span className="text-neutral-300 font-semibold text-xs tracking-widest">maxbillioninvestment@gmail.com</span>
                  </div>
                </div>
              </div>
              <Suscription />
            ...
            <div className="flex justify-between mt-12">
              ...
              <div className="flex items-center justify-between gap-7 max-w-xl">
                <a href="https://facebook.com/profile.php?id=61582493404347">
                ...
                <a href="https://chat.whatsapp.com/CTArkhXL5YJ4RXr2OCzXFu?mode=ems_copy_t">
                ...
                <a href="mailto:maxbillioninvestment@gmail.com">
