...
function Testimonials() {
  return (
    <div className="mt-36 flex flex-col items-center">
          ...
          <div className="flex flex-[5] items-start gap-6 max-w-5xl mx-auto mt-12">
            <div className="flex flex-[1.8] justify-around items-start gap-2 space-y-4 flex-wrap">
                {data.testimonials.map((testimonial, i) => (
                  <div key={i} className="group w-25 aspect-square overflow-hidden rounded-2xl cursor-pointer ring-4 ring-transparent hover:ring-[var(--primary-color)]">
